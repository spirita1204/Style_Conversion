...
def insert(request):
    if request.method == "POST":
        ...
        wv, sr = librosa.load('media/test3.mp3', sr=16000)  #Load waveform
        print(wv.shape)
        speca = prep(wv) 
        abwv = towave(speca)  #
        
        twz = message.objects.create(username=username, transfer_audio="test3_output.wav")
        twz.save()
        sf.write('media/output_audio/test3_output.wav', abwv, sr)
        """print("Using loaded model to predict......")
        load_model = keras_load_model("C:/Users/User/iris_model.h5")
